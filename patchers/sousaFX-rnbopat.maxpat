        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1480.125, 83.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 654.0, 151.0, 97.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 654.0, 188.0, 89.0, 22.0 ],
                    "text": "removeObjects"
                }
            },
            {
                "box": {
                    "code": "function removeObjects() {\n    var thisPatcher = this.patcher;\n    var rnboObj = thisPatcher.getnamed(\"sousaFxRnbo\");\n    var rnboSubPatcher = rnboObj.subpatcher();\n\n    var bindingsObj = rnboSubPatcher.getnamed(\"bindings\");\n    var bindingsSubPatcher = bindingsObj.subpatcher();\n\n    var obj = bindingsSubPatcher.firstobject;\n    var toRemove = [];\n\n    while (obj) {\n        var text = String(obj.boxtext);\n        if (text.indexOf(\"p @file sendbind\") === 0) {\n            toRemove.push(obj);\n        }\n        obj = obj.nextobject;\n    }\n\n    for (var i = 0; i < toRemove.length; i++) {\n        bindingsSubPatcher.remove(toRemove[i]);\n    }\n\n    post(\"Removed \" + toRemove.length + \" objects\\n\");\n}\r\n//\r\n// https://claude.ai/share/1fff2cf0-19f0-41be-a402-3a202d7d20c6\r\n//",
                    "filename": "none",
                    "fontface": 0,
                    "fontname": "<Monospaced>",
                    "fontsize": 12.0,
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 654.0, 226.0, 458.0, 301.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 447.0, 131.0, 58.0, 22.0 ],
                    "text": "loadbang"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 447.0, 188.0, 97.0, 22.0 ],
                    "text": "s start_autobuild"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 225.0, 131.0, 133.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 225.0, 160.0, 33.0, 22.0 ],
                    "text": "front"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 225.0, 188.0, 67.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 19.0, 226.0, 466.0, 301.0 ],
                    "saved_object_attributes": {
                        "parameter_enable": 0
                    }
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 260.0, -40.0, 1272.0982730263158, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 24,
                    "numoutlets": 0,
                    "patching_rect": [ 550.8263888888889, 87.0, 909.6111111111111, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1518.8125, 83.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1557.5, 83.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "inletInfo": {
                        "IOInfo": [
                            ...
                            },
                            {
                                ...
                                "index": 2,
                                "tag": "in2",
                                "comment": "02 playback L"
                            },
                            {
                                "type": "signal",
                                "index": 3,
                                "tag": "in3",
                                "comment": "03 playback R"
                            },
                            {
                                "type": "signal",
                                "index": 4,
                                "tag": "in4",
                                "comment": "04 pre-lfp fx l"
                            },
                            {
                                "type": "signal",
                                "index": 5,
                                "tag": "in5",
                                "comment": "05 pre-lfp fx r"
                            },
                            {
                                "type": "signal",
                                "index": 6,
                                "tag": "in6",
                                "comment": "06 pass-lfp fx l"
                            },
                            {
                                "type": "signal",
                                "index": 7,
                                "tag": "in7",
                                "comment": "07 pass-lfp fx r"
                            },
                            {
                                "type": "signal",
                                "index": 8,
                                "tag": "in8",
                                "comment": "08 solo fx l"
                            },
                            {
                                "type": "signal",
                                "index": 9,
                                "tag": "in9",
                                "comment": "09 solo fx r"
                            },
                            {
                                "type": "signal",
                                "index": 10,
                                "tag": "in10",
                                "comment": "10 main delay receive L"
                            },
                            {
                                "type": "signal",
                                "index": 11,
                                "tag": "in11",
                                "comment": "11 main delay receive R"
                            },
                            {
                                "type": "signal",
                                "index": 12,
                                "tag": "in12",
                                "comment": "12 looper delay receive L"
                            },
                            {
                                "type": "signal",
                                "index": 13,
                                "tag": "in13",
                                "comment": "13 looper delay receive R"
                            },
                            {
                                "type": "signal",
                                "index": 14,
                                "tag": "in14",
                                "comment": "14 solo delay receive L"
                            },
                            {
                                "type": "signal",
                                "index": 15,
                                "tag": "in15",
                                "comment": "15 solo delay receive R"
                            },
                            {
                                "type": "signal",
                                "index": 16,
                                "tag": "in16",
                                "comment": "16 drum delay receive L"
                            },
                            {
                                "type": "signal",
                                "index": 17,
                                "tag": "in17",
                                "comment": "17 drum delay receive R"
                            },
                            {
                                "type": "signal",
                                "index": 18,
                                "tag": "in18",
                                "comment": "18 reverb receive L"
                            },
                            {
                                "type": "signal",
                                "index": 19,
                                "tag": "in19",
                                "comment": "19 reverb receive R"
                            },
                            {
                                "type": "midi",
                                "index": -1,
                    ...
                    "outletInfo": {
                        "IOInfo": [
                            ...
                            },
                            {
                                ...
                                "index": 35,
                                "tag": "out35",
                                "comment": "solo timeFX L"
                            },
                            {
                                "type": "signal",
                                "index": 36,
                                "tag": "out36",
                                "comment": "solo timeFX R"
                            },
                            {
                                "type": "signal",
                                "index": 37,
                    ...
                    "outlettype": [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "", "int", "list" ],
                    "patching_rect": [ 10.0, 15.0, 1605.1875, 24.0 ],
                    "rnboattrcache": {
                        "gpin/deadzone_right": {
                        ...
                        "bindings/autoswing_enable": {
                            "label": "autoswing_enable",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        "bindings/Ext_FX": {
                        ...
                        "bindings/disable env mod of lpf freq": {
                            "label": "disable env mod of lpf freq",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        ...
                        "bindings/crossfade binding mode": {
                            "label": "crossfade binding mode",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        "low_boost/low_boost": {
                        ...
                        "jb_micpre/allpass_enable": {
                            "label": "allpass_enable",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        "init/gain": {
                        ...
                        "jb_micpre/allpass_freq_Hz": {
                            "label": "allpass_freq_Hz",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        "solo/himid": {
                        ...
                        "wobblefxbypass/overdrive/tuba_drive": {
                            "label": "tuba_drive",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        ...
                        "bindings/Ext_FX_latency_samples": {
                            "label": "Ext_FX_latency_samples",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        ...
                        "bindings/lpf freq mod mode": {
                            "label": "lpf freq mod mode",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        ...
                        "playback_volume": {
                            "label": "playback_volume",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        "wobblefxbypass/harmonic_mod_peak": {
                            "label": "harmonic_mod_peak",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        "wobblefxbypass/overdrive/harmonic_pre-asym_gain": {
                            "label": "harmonic_pre-asym_gain",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        "wobblefxbypass/overdrive/harmonic_output_gain": {
                            "label": "harmonic_output_gain",
                            "isEnum": 0,
                            "parsestring": ""
                        },
                        "wobblefxbypass/overdrive/harmonic_dry_amt": {
                            "label": "harmonic_dry_amt",
                            "isEnum": 0,
                            "parsestring": ""
                        }
                    },
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 176.9671052631579, -40.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1596.1875, 83.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
