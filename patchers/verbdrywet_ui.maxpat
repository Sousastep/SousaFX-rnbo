        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 638.0, 257.0, 92.0, 22.0 ],
                    "restore": [ 0.0 ],
                    "saved_object_attributes": {
                        "parameter_enable": 0,
                        "parameter_mappable": 0
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "float" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 678.0, 295.0, 71.0, 54.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 94.0, 26.0, 71.0, 54.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_initial": [ 50.0 ],
                            "parameter_longname": "delay vol",
                            "parameter_mmax": 12.0,
                            "parameter_mmin": -24.0,
                            "parameter_modmode": 3,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 739.0, 677.0, 111.0, 22.0 ],
                    "text": "prepend #1/del_vol"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 43.0, 26.0, 71.0, 54.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_initial": [ 50.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ -8.0, 26.0, 71.0, 54.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_initial": [ 50.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ -12.0, 82.0, 71.0, 54.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
